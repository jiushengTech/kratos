...
const (
	...
	transportHTTPPackage = protogen.GoImportPath("github.com/jiushengTech/kratos/v2/transport/http")
	bindingPackage       = protogen.GoImportPath("github.com/jiushengTech/kratos/v2/transport/http/binding")
)
